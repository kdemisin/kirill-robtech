...
if("FALSE" STREQUAL "TRUE")
  set(beginner_tutorials_SOURCE_PREFIX /home/tudeng/kirill-robtech/src/beginner_tutorials)
  set(beginner_tutorials_DEVEL_PREFIX /home/tudeng/kirill-robtech/devel)
  ...
  set(beginner_tutorials_INSTALL_PREFIX /home/tudeng/kirill-robtech/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'tudeng <tudeng@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tudeng/kirill-robtech/install/${idir}'.  Ask the maintainer 'tudeng <tudeng@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/tudeng/kirill-robtech/install/lib;/opt/ros/indigo/lib)
